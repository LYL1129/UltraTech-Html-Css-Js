...
// jQuery - 获取并设置 CSS 类，对被选中的元素进行添加删除class类
$(document).ready(function(){
    // 选择window浏览器窗口对象，scroll滚动事件发生时，运行js函数
    ...
    // 切换式菜单/导航栏脚本
    // jQuery的方法toggleClass() 方法对添加和移除被选元素的一个或多个类进行切换
    // 对添加的active类进行切换
...
// login-form script
// var proList=[ "北京市", "天津市", "上海市", "重庆市", "河北省", "山西省", "内蒙古", "辽宁省", "吉林省","黑龙江省", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省","湖南省","广东省", "广西", "海南省", "四川省", "贵州省", "云南省", "西藏", "陕西省", "甘肃省", "青海省","宁夏", "新疆", "香港", "澳门", "台湾省" ];
// var allCityList=[
...
//获取display：none的弹窗元素ID
let login_form = document.getElementById('wrapper');
let sign_form = document.getElementById("mapper")
